...
if (isset($_POST['upload'])) {
   $file = 'images/landscapeandwildlife/'.$_FILES['image']['name'];

   $query = "INSERT INTO upload(image_name,imgtype) VALUES ('$file','landscapeandwildlife')";
...
<head>
   ...
   <title>LANDSCAPE AND WILDLIFE PHOTOGRAPHY</title>
...
<h1 class = "text-center">LANDSCAPE AND WILDLIFE PHOTOGRAPHY</h3>
   <div class = "container">
      <div class = "col-md-12">
         <div class = "row">
         ...
         <div class = "row align-items-center">
               ...
               <?php
                  ...
                  $sql = "SELECT * FROM upload WHERE imgtype='landscapeandwildlife' ORDER BY id DESC";
