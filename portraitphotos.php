...
if (isset($_POST['upload'])) {
   $file = 'images/portraits/'.$_FILES['image']['name'];

   $query = "INSERT INTO upload(image_name,imgtype) VALUES ('$file','portraits')";
...
<h1 class = "text-center">PORTRAITS</h3>
   <div class = "container">
      <div class = "col-md-12">
         <div class = "row">
         ...
         <div class = "row align-items-center">
               ...
               <?php
                  ...
                  $sql = "SELECT * FROM upload WHERE imgtype='portraits' ORDER BY id DESC";
